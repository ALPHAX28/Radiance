  ...
  void onError(ErrorEntity eInfo) {
    ...
    switch (eInfo.code) {
      case 401:
        ...
        break;
      default:
        EasyLoading.showError("Can't connect to the Server" );
        break;
    }
  }
      ...
      case DioErrorType.response:
        {
          try {
            ...
            switch (errCode) {
              ...
              case 403:
                return ErrorEntity(code: errCode, message: "The server refuses to connect");
              case 404:
                return ErrorEntity(code: errCode, message: "can't reach the servers");
              case 405:
