...
class VoiceCallViewController extends GetxController {
  ...
  addCallTime() async {
    ...
    String sendContent = "${state.call_time_num.value} "+" "+"📞";
    ...
    if(state.call_time.value == '00:00'){
      ...
      sendMessage("Voice call time: ${state.call_time_num.value}");
    }
    // sendMessage(sendcontent);
  }
  ...
  switchSpeakerphone() async {
    await engine.setEnableSpeakerphone(!state.enableSpeaker.value);
